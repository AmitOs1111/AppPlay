...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(
        ['exports', 'react', 'react-dom', 'react-router', '@remix-run/router'],
        t
      )
    : t(
        ((e =
  ...
  function v(e, t) {
    ...
    if (d((s = e)) && 'form' === s.tagName.toLowerCase()) {
      ...
      if (
        ...
        (n = e.getAttribute('formmethod') || u.getAttribute('method') || l),
        (a =
    ...
    return (
      ...
      { action: r, method: n.toLowerCase(), encType: a, formData: i, body: u }
    )
  }
  const y = [
      'onClick',
  ...
  const x =
    ...
    L = i.forwardRef(function (e, t) {
      let n,
        ...
        w = !1
      if ('string' == typeof p && F.test(p) && ((n = p), x))
        try {
    ...
    T = i.forwardRef(function (e, t) {
      ...
      a ||
        ...
        (E = E.toLowerCase())),
        P && R && (P = o.stripBasename(P, R) || P)
      const O = '/' !== E && E.endsWith('/') ? E.length - 1 : E.length
      let A,
        C = _ === E || (!l && _.startsWith(E) && '/' === _.charAt(O)),
        N =
          null != P &&
          (P === E || (!l && P.startsWith(E) && '/' === P.charAt(E.length))),
        j = { isActive: C, isPending: N, isTransitioning: S },
        x = C ? n : void 0
      A =
        'function' == typeof u
          ? u(j)
  ...
  function V() {
    ...
    return i.useCallback(
      function (r, o) {
        ...
        let { action: a, method: i, encType: u, formData: s, body: c } = v(r, t)
        if (!1 === o.navigate) {
  ...
  function z(e, t) {
    ...
    return (
      ...
      '/' !== a &&
        (l.pathname = '/' === l.pathname ? a : o.joinPaths([a, l.pathname])),
      r.createPath(l)
    )
  }
        ...
        i.useLayoutEffect(() => {
          let e =
            ...
            n =
              null == a
                ? void 0
                : a.enableScrollRestoration(W, () => window.scrollY, e)
          return () => n && n()
        }, [a, l, t]),
        i.useLayoutEffect(() => {
          if (!1 !== u)
  ...
  function J(e, t) {
    ...
    return (
      null != o.matchPath(u.pathname, c) || null != o.matchPath(u.pathname, s)
    )
  }
  Object.defineProperty(e, 'AbortedDeferredError', {
    ...
    (e.BrowserRouter = function (e) {
      let { basename: t, children: n, future: a, window: u } = e,
        s = i.useRef()
      null == s.current &&
        (s.current = o.createBrowserHistory({ window: u, v5Compat: !0 }))
      let c = s.current,
    ...
    (e.RouterProvider = function (e) {
      ...
      i.useLayoutEffect(() => n.subscribe(R), [n, R]),
        ...
        i.useEffect(() => {
          if (d && s && n.window) {
            ...
            r.finished.finally(() => {
              m(void 0), b(void 0), c(void 0), f({ isTransitioning: !1 })
            }),
              b(r)
          }
        }, [w, s, d, n.window]),
      ...
      let S = i.useMemo(
        ...
        O = n.basename || '/',
        A = i.useMemo(
          () => ({ router: n, navigator: S, static: !1, basename: O }),
          [n, S, O]
        )
      return i.createElement(
        i.Fragment,
    ...
    (e.useFetcher = function (e) {
      ...
      let { key: n } = void 0 === e ? {} : e,
        ...
        f = null == (t = l.matches[l.matches.length - 1]) ? void 0 : t.route.id
        ...
        y = i.useMemo(
          () =>
            i.forwardRef((e, t) =>
              i.createElement(
                U,
                s({}, e, { navigate: !1, fetcherKey: m, ref: t })
              )
            ),
          [m]
        ),
